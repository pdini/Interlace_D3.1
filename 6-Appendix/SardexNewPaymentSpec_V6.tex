...
\textcolor{red}{@Egon: I think you may need to rework the following paragraph, since Figure 2.13b has now changed (Bisoo --> Income is now a SysAdmin Credit operation)}
...
\textcolor{red}{@Egon: the Bisoo --> Income operation is now here:}
%Old:
