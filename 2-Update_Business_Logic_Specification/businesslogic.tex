...
\caption{\small\textbf{Visualization of the $CC$ account limit}}
...
\caption{\small\textbf{Visualization of the $Prepaid$ account limits}}
...
Tables \ref{tab:ProfileMetaData1} and \ref{tab:ProfileMetaData2} show the meta-data \textcolor{red}{\bf some of which} the user can inspect and edit. For example, the user may wish to include his/her personal name in addition to the company name. \todo{Add asterisk to the fields that can be modified by the user}
