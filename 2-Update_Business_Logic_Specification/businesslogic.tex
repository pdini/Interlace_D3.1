...
Figure \ref{fig:accountLimits} shows a visualization of the account limits that apply to SRD accounts. The thick vertical green arrows highlight that the calculation of the sale volume is defined as the sum of all the sales performed in one year. Thus, the sum of all the vertical green arrows is 50,000.
...
\begin{figure}[htbp]
\centering
\includegraphics[width=14cm]{Figures/Account_Limits}
\caption{\small\textbf{Visualization of the SRD account limits}}
\label{fig:accountLimits}
\end{figure}
\vspace{-0.5cm}
...
\todo{Add asterisk to the fields that can be modified by the user}
