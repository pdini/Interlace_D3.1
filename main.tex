...
the business logic. Further the code structure will be described and examined in terms of necessary deviations based on the original ASM definitions in D2.1. Finally a presentation of the enclosed running environment is given and
elaborated about the future connection to the actual blockchain driven back end.
\end{abstract}
...
\input{2-Design-Implementation/design}
\input{3-Testing-Evaluation/testing}
\input{4-Outlook/outlook}
