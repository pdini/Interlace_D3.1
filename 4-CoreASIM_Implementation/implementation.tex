...
Next the emphasis is put on explaining rules and locations not explained in detail or mentioned at all in this document yet. 
...
\hline
\textbf{Function/Rule Name} & Used For & Attached Parameters & Example \\
\Xhline{1.5pt}
...
\caption{\small\textbf{Important functions and rules}}
\label{tab:impl-func-docu}
\end{centering}
\vspace{-0.5cm}
\end{table}
...
\begin{tabular}{ r | r | r }
\hline
\textbf{Location Name} & Used For & Example \\
\Xhline{1.5pt}
...
\caption{\small\textbf{Important locations}}
\label{tab:impl-location-docu}
\end{centering}
\vspace{-0.5cm}
\end{table}
