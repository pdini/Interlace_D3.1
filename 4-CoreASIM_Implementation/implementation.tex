...
Lets take a look at a possible implementation of a credit review request to a running server:
...
When taking a look at the last line it can be observed that the $send$ command is taking $CREDITREQUEST$ location for the message content and location $CreditReviewReq$  is used defining the message subject.
The different types of messages are now by definition classified using the name of the subject. In the above script ... TODO
