...
Next the missing parts are added up to get the full picture on how the clients are started. In particular in which way the base rules for a client are defined and how they are finally instantiated and handled during runtime.
